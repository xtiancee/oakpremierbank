...
,account=:account,mobile=:mobile,gender=:gender, dob=:dob, address=:address, work=:work ,
 marry=:marry where id = '$session_id'");
...
header('location: edit-profile?action=edit');
}
else
{
?>
				...
				<section>
					<div class="section-body">
						<div class="row">
							...
							<header class="text-color">Edit Profile</header>
<br/>
								<div class="card">
				...
				if(isset($_GET['action']) && $_GET['action'] == 'edit'){
					...
					echo " <h2 class='w3-small'>Profile  successfuly Edited</h2></div> ";
				}
				?>                                  
								 <?php 
...
<div class="row">
			...
			<div class="form-group">
				<label>Balance</label> 
				<input type="text" class="form-control"  value="<?php echo $row['currency'] ; ?><?php 
				$number = $row['balance'] ;
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-success" name="update"><span id="textw"> Update </span>
