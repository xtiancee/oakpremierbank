...
<head>
   ...
   <!-- BEGIN STYLESHEETS -->
    ...
    <link href="assets/admin/css/components-rounded.min.css" rel="stylesheet" id="style_components"
          type="text/css"/>
    ...
    <link href="assets/admin/css/darkblue.min.css" rel="stylesheet" type="text/css"
          id="style_color"/>
    <link href="assets/admin/css/datatables.min.css" rel="stylesheet" type="text/css"/>
    <link href="assets/admin/css/datatables.bootstrap.css"
				...
				<div class="headerbar-left">
					<ul class="header-nav header-nav-options">
						<li class="header-nav-brand" >
							<div class="brand-holder">
								<a href="../admin/management">
									<span class="text-lg text-bold "style="color:#ff9966!important">Oak Premier Bank</span>
								</a>
							</div>
						</li>
						<li>
						...
						<li class="header-nav-brand" >
							<div class="brand-holder">
								<a href="../admin/management">
								<i class="fa fa-fw fa-dashboard text-warning"></i>Dashboard</a>
							</div>
						</li>
					</ul>
				</div>
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu animation-dock">
								...
								if($rws['is_admin'] == true) {
									?>
								<li><a href="../user"><i class="fa fa-fw fa-user text-danger"></i> User Dashboard</a></li>
									<?php
								}
								?>
