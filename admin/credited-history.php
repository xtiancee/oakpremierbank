				...
				<section>
					<div class="section-body">
						<div class="row">
							...
							<header class="text-color">Deposit History</header>
<br/>
								<div class="card">
			...
			echo '€';
				...
				; ?><?php echo $amount ; ?></td>
													...
													<span class="btn btn-success btn-xs">	Completed </span> 
														...
														elseif($status == false){
															?>
														   <button   onclick="document.getElementById('account<?php echo $id; ?>').style.display='block'"  class="btn btn-danger btn-xs"><i class="fa fa-spinner w3-spin"></i> Pending </button> <span  onclick="document.getElementById('account<?php echo $id; ?>').style.display='block'" class="btn btn-info btn-xs"> Mark As Done</span>  
