...
$recipients =  $_POST['email_list'];
    ...
    foreach($email_array as $email)
    {
		$to =  $email;
			...
			$body = "<div style='background:#00FA9A; color:#000; border:1px solid #cccccc; padding:5px 10px'> 
			<p><img alt='uniontrustreserve logo' src='https://oakpremierbank.com/assets/img/logo.png' style='text-align:center;height:100px; width:100%' /></p>
			<br>
			". $_POST['body']. " 	<div style='background:#141f1f;color:#fff; border:1px solid #cccccc; padding:5px 10px'>
			This information contained and transmitted by this E-mail is proprietary to oakpremier bank and/or its customer and is intended for use only by the individual or entity to which it is addressed, and may contain information that is privilege, confidential or exempt from a disclosure under applicable law. If this is a forwarded message,the content of this E-mail may not have been sent with the authority of the bank oakpremier shall not be liable for any mails sent without due authorization or through unauthorized access. If you are not the intended recipient, an agent of the intended recipient or a person responsible for delivering the information to the named recipient, you are notified that any use, distribution, transmission, printing, copying or dissemination of this information in any way or in any manner is strictly prohibited. If you have received this communication in error please delete this mail and notify us immediately at info@oakpremierbank.com
			<p>Thanks<p/>			
		<p style='color:#e67e22'>oakpremierbank cares</p>
...
header('location: email-messenger?action=email');
}
else
{
?>
				...
				<section>
					<div class="section-body">
						<div class="row">
							...
							<header class="text-color">Email Messenger</header>
<br/>
								<div class="card">
        ...
        <div class="modal-body">
		  ...
		  <div class="row">
			...
			<div class="form-group">
				...
				<textarea class="form-control" name="email_list"  placeholder="(seperate with comma)eg william@gmail.com,viki@gmail.com" required></textarea>
			</div>
		    </div>
			<div class="col-md-12">
			<div class="form-group">
				<label>Message</label>
				<textarea class="form-control" name="body" id="ckeditor_full" required></textarea>
			</div>
		    </div>
